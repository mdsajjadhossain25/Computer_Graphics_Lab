...
def main():
    ...
    # Draw white polygon before rotation
    plt.plot([], [], color='white', label='Before Rotation', linewidth=2)
    draw(x.copy(), y.copy())
    ...
    # Draw yellow polygon after rotation
    draw(x, y)
...
The original polygon will be shown in white and the rotated polygon in yellow.
"""